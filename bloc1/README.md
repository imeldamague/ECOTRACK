...
- [📥 Telecharger le rapport Bloc 1](./docs/ECOTRACK_Bloc1_Final.pdf)
- [🗺️ Schema reseau Draw.io](./diagrams/ECOTRACK_Schema_Final.drawio)
- [📊 Diagramme BPMN](./diagrams/ECOTRACK_BPMN_Processus.drawio)
- [📅 Gantt 8 sprints](./diagrams/ECOTRACK_Gantt.drawio)
...
- S1 — 7-20 Avril — Infrastructure base ✅
- S2 — 21 Avril-4 Mai — Reseau + BDD ✅
- S3 — 5-18 Mai — Application IoT ✅
- S4 — 19 Mai-1 Juin — Securite IDS + SIEM ✅
- S5 — 2-8 Juin — WAF + 15 tests ✅
- S6 — 9-12 Juin — Fusion 8 VMs ✅
- S7 — 13-19 Juin — Docs + Demo 🔄
- S8 — 29-30 Juin — Soutenance INGETIS 📅
